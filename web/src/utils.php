    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input name="endpoint" class="form-control input-sm chat-input" value="'.$endpoint.'" placeholder="endpoint hostname or IP address" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]+$" required />
        </div>
